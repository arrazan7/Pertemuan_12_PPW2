...
class GalleryController extends Controller
{
    ...
    public function edit($gallery)
    {
        ...
        return view('gallery.index', compact('title', 'description', 'picture', 'gallery'));
    }
    ...
    public function update(Request $request, $gallery)
    {
        ...
        return redirect()->route('menampilkan_gallery')->with('success', 'Data berhasil diupdate');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $post->delete();
        //redirect to index
        return redirect()->route('menampilkan_gallery')->with(['success' => 'Data Berhasil Dihapus!']);
    }
}
